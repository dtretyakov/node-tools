...
namespace Console.Console
{
    ...
    internal class WpfConsole : ObjectWithFactory<WpfConsoleService>, IDisposable
    {
        ...
        {
            get { return ServiceProvider.GetService<Microsoft.VisualStudio.OLE.Interop.IServiceProvider>(typeof (Microsoft.VisualStudio.OLE.Interop.IServiceProvider)); }
        }
        ...
        public IVsTextView VsTextView
        {
            get
            {
                if (_view == null)
                {
                    ITextViewRoleSet textViewRoleSet = Factory.TextEditorFactoryService.CreateTextViewRoleSet(
