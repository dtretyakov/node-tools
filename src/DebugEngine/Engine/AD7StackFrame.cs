...
namespace DebugEngine.Engine
{
    ...
    internal class AD7StackFrame : IDebugStackFrame2, IDebugExpressionContext2
    {
        ...
        private readonly NodeEvaluationResult[] _locals;
        private readonly NodeEvaluationResult[] _parameters;
        ...
        {
            pbstrLanguage = NodeConstants.LanguageName;
            pguidLanguage = DebuggerConstants.GuidLanguageJavaScript;
